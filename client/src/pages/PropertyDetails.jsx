    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const relRes = await axios.get(`http://localhost:3000/api/properties`);
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '40px' }}>
                    ...
                    <div style={{ position: 'relative', width: '100%', maxWidth: '800px', margin: '0 auto', background: '#000', borderRadius: '12px', overflow: 'hidden', height: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        {property.images && property.images.length > 0 ? (
                            <>
                                <img src={`http://localhost:3000${property.images[currentImageIndex]}`} alt="Əmlak" style={{ maxHeight: '100%', maxWidth: '100%', objectFit: 'contain' }} />
